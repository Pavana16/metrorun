      ...
      child: RotatedBox(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              RotatedBox(quarterTurns: 1, child: buildOption(LocaleKeys.Profile.tr(), 3)),
              RotatedBox(quarterTurns: 1, child: buildOption(LocaleKeys.Map.tr(), 1)),
              RotatedBox(quarterTurns: 1, child: buildOption(LocaleKeys.Card.tr(), 2)),
              RotatedBox(quarterTurns: 1, child: buildOption(LocaleKeys.Ticekts.tr(), 0)),
            ],
          ),
        ),
      ),
